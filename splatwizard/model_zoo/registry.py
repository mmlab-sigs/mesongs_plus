...
from .chimerags.config import ChimeraGSDistillOptimizationParams, ChimeraGSEncodeOptimizationParams, ChimeraGSParams
...
from .speedy_splat_normal.config import SpeedySplatNormalModelParams, SpeedySplatNormalOptimizationParams
...
from .contextgs.config import ContextGSModelParams, ContextGSOptimizationParams
...
from .mesongs_plus.config import MesonGSPlusModelParams, MesonGSPlusOptimizationParams
...
MODEL_REGISTRY = {
    ...
    "contextgs": (ContextGSModelParams, ContextGSOptimizationParams, dynamic_load('contextgs.model', 'ContextGSModel')),
...
"speedy_norm": (SpeedySplatNormalModelParams, SpeedySplatNormalOptimizationParams, dynamic_load('speedy_splat_normal.model', 'SpeedySplatNormal')),
    "mesongs": (MesonGSModelParams, MesonGSOptimizationParams, dynamic_load('mesongs.model', 'MesonGS')),
    "mesongs_plus": (MesonGSPlusModelParams, MesonGSPlusOptimizationParams, dynamic_load('mesongs_plus.model', 'MesonGSPlus'))
}
